...
export async function launch(
	...
	//add these args to satifiy intel branch of chrome's requirements hardware acceleration by pcg
	//addToArgs("--enable-accelerated-video-decode");
	//addToArgs("--enable-gpu-memory-buffer-compositor-resources");
	addToArgs("--no-sandbox");
	addToArgs("--disable-setuid-sandbox");
	addToArgs("--no-zygote");
	//addToArgs("--disable-gpu");
	//addToArgs("--disable-dev-shm-usage");
	addToArgs("--no-first-run");
	//addToArgs("single-process");
	//addToArgs("--display=:0")
	addToArgs("--enable-features=VaapiVideoDecodeLinuxGL");
	addToArgs("--disable-features=UseChromeOSDirectVideoDecoder");
	addToArgs("--ignore-gpu-blacklist");
	addToArgs("--enable-zero-copy");
	addToArgs("--enable-gpu-rasterization");
